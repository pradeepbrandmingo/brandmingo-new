...
import ShopsyManServicesHero from "../../servicespags/ShopsyManServicesComponent/ShopsyManServicesHero";
import ShopsyExpertiseDetails from "../../servicespags/ShopsyManServicesComponent/ShopsyExpertiseDetails";
...
`}</style>
  ...
  `}</style>
                  ...
                  <div className="react-expertise-section">
                    <ShopsyExpertiseDetails />
                  </div>

                  {/* S6 */}
                  <div className="process-section-wrapper">
                    <ShopsyProcessSection />
                  </div>
...
export default ShopsyManServices;
