...
import ContentCreationHero from "../../servicespags/ContentCreationComponents/ContentCreationHero";
import ContentCreationExpertiseDetails from "../../servicespags/ContentCreationComponents/ContentCreationExpertiseDetails";
import ContentCreationProcessSection from "../../servicespags/ContentCreationComponents/ContentCreationProcessSection";
import ContentCreationModernDigital from "../../servicespags/ContentCreationComponents/ContentCreationModernDigital";
import ContentCreationCtaBanner from "../../servicespags/ContentCreationComponents/ContentCreationCtaBanner";
import ContentCreationPricingPlans from "../../servicespags/ContentCreationComponents/ContentCreationPricingPlans";
...
`}</style>
  ...
  `}</style>
                  ...
                  <div className="react-expertise-section">
                    <ContentCreationExpertiseDetails />
                  </div>

                  {/* S6 */}
                  <div className="process-section-wrapper">
                    <ContentCreationProcessSection />
                  </div>

                  <div className="modern-cta-section">
                    <ContentCreationModernDigital />
                    <ContentCreationCtaBanner />
                  </div>
