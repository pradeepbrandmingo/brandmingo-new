...
import GoogleAdsHero from "../../servicespags/GoogleAdsComponents/GoogleAdsHero";
import GoogleAdsExpertiseDetails from "../../servicespags/GoogleAdsComponents/GoogleAdsExpertiseDetails";
import GoogleAdsProcessSection from "../../servicespags/GoogleAdsComponents/GoogleAdsProcessSection";
import GoogleAdsModernDigital from "../../servicespags/GoogleAdsComponents/GoogleAdsModernDigital";
import GoogleAdsCtaBanner from "../../servicespags/GoogleAdsComponents/GoogleAdsCtaBanner";
import GoogleAdsPricingPlans from "../../servicespags/GoogleAdsComponents/GoogleAdsPricingPlans";
...
`}</style>
  ...
  `}</style>
                  ...
                  <div className="modern-cta-section">
                    <GoogleAdsModernDigital />
                    <GoogleAdsCtaBanner />
                  </div>

                  {/* PricingPlans */}
                  <div className="pricing-section">
                    <GoogleAdsPricingPlans />
                  </div>
