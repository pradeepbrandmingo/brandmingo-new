...
import CustomWebDevHero from "../../servicespags/CustomWebDesignComponent/CustomWebDevHero";
import CustomWebDevExpertiseDetails from "../../servicespags/CustomWebDesignComponent/CustomWebDevExpertiseDetails";
import CustomWebDevProcessSection from "../../servicespags/CustomWebDesignComponent/CustomWebDevProcessSection";
import CustomWebDevModernDigital from "../../servicespags/CustomWebDesignComponent/CustomWebDevModernDigital";
import CustomWebDevCtaBanner from "../../servicespags/CustomWebDesignComponent/CustomWebDevCtaBanner";
import CustomWebDevPricingPlans from "../../servicespags/CustomWebDesignComponent/CustomWebDevPricingPlans";
...
`}</style>
  ...
  `}</style>
                  ...
                  <div className="react-expertise-section">
                    <CustomWebDevExpertiseDetails />
                  </div>

                  {/* S6 */}
                  <div className="process-section-wrapper">
                    <CustomWebDevProcessSection />
                  </div>

                  <div className="modern-cta-section">
                    <CustomWebDevModernDigital />
                    <CustomWebDevCtaBanner />
                  </div>
                  ...
                  <div className="engagement-section">
                    {/* <EngagementModels /> */}
                    <CustomWebDevEngagementModels />
                  </div>

                  <div className="pricing-final-section">
                    <CustomWebDevPricingSection />
                  </div>
