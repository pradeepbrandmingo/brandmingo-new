...
/* Dummy client logos — replace each `logo` value with your real client logo path/URL */
const LEFT_CLIENTS = [
  {
    name: "Boyomo",
  ...
  return (
    <div className="cl-card">
      <div className="cl-avatar">
        <img src={logo} alt={name} className="cl-avatar-img" loading="lazy" />
      </div>
    </div>
  );
}
        ...
        >
          ...
          <div className="cl-stats-center">
            ...
            >
              ...
              {/* Card body */}
              <div className="cl-stats-card">
                <p className="cl-stats-number">100+</p>
                <p className="cl-stats-label">Happy Clients</p>
                <div className="cl-stats-bar">
                  <div className="cl-stats-bar-fill" />
                </div>
