        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Amazon Management</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/1f3c0dda-d73f-4316-b164-4cd0f8bba421/h0ctqLlmYg.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Optimized Listings
            </div>
...
export default AmazonManServicesHero;
