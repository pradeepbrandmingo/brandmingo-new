      ...
      <div className="auto-container">
        <div className="rdh-grid">
          ...
          >
            ...
            <h1 className="title">Custom Web</h1>
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Custom Web Design</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/98b0f094-3bce-4311-9367-40ce1c214fce/0KtnQXwUTe.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Modern UI/UX
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Conversion Focused
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Create visually stunning and user-focused websites designed to
              deliver seamless experiences. We don’t just design interfaces — we
              craft intuitive, conversion-driven designs that enhance usability,
              engagement, and overall brand impact.
            </p>
...
export default CustomWebDevHero;
