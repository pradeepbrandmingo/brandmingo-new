      ...
      <div className="auto-container">
        <div className="rdh-grid">
          ...
          >
            ...
            <h1 className="title">Snapdeal</h1>
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Snapdeal Management</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/5b0db1f8-34ff-4441-ad73-9c2d8324fd5a/CYPCgG4k7o.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
...
export default SnapdealServicesHero;
