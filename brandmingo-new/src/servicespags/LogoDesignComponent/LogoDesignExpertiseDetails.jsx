...
const servicesData = [
  {
    ...
    desc: "We create unique, memorable, and professionally crafted logos that perfectly represent your brand identity.",
    points: [
      "100% custom logo concepts",
      "Designed for brand recognition",
      "Creative and modern styles",
  ...
  },
  {
    ...
    desc: "Build a consistent visual identity with carefully crafted branding elements beyond just the logo.",
    points: [
      "Brand color palette",
  ...
  },
  {
    id: "gads",
    title: "Logo Redesign",
    desc: "Refresh your existing logo with a modern, professional design while preserving your brand essence.",
    points: [
      "Modern logo makeover",
      "Improved brand appeal",
      "Enhanced visual consistency",
      "Scalable logo formats",
    ],
  },
  {
    id: "meta",
    title: "Minimalist Logo Design",
    desc: "Clean, timeless, and impactful logo designs that leave a lasting impression across every platform.",
    points: [
      "Simple and elegant concepts",
  ...
  },
  {
    ...
    desc: "Professional logos designed specifically for startups, businesses, and growing brands.",
    points: [
  ...
  },
  {
    ...
    desc: "Receive multiple logo variations and realistic mockups to visualize your brand across different applications.",
    points: [
  ...
  {
    id: "tracking",
    title: "Vector File Delivery",
    desc: "Get high-quality, scalable logo files ready for print, digital, and commercial use.",
    points: [
      "AI, EPS & SVG formats",
  ...
  },
  {
    ...
    desc: "Receive a professional logo usage guide to maintain consistency across all branding materials.",
    points: [
      "Logo usage rules",
...
const LogoDesignExpertiseDetails = () => {
...
export default LogoDesignExpertiseDetails;
