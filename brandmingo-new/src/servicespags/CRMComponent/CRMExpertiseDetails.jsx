...
const servicesData = [
  {
    ...
    desc: "We build custom CRM solutions tailored to your business processes, helping you manage customers, sales, and operations efficiently.",
    points: [
      "Custom CRM designed for your business",
      "Scalable architecture for future growth",
      "Fast, secure, and high-performance system",
  ...
  },
  {
    ...
    desc: "Capture, organize, and track leads with an intelligent CRM designed to improve sales conversions.",
    points: [
  ...
  },
  {
    ...
    desc: "Manage customer information, communication history, and interactions from a centralized dashboard.",
    points: [
  ...
  },
  {
    ...
    desc: "Automate repetitive business tasks to improve productivity and reduce manual work.",
    points: [
  ...
  },
  {
    ...
    desc: "Connect your CRM with third-party tools like email, payment gateways, ERP, and marketing platforms.",
    points: [
  ...
  },
  {
    ...
    desc: "Get real-time reports and business insights to make smarter decisions with your CRM.",
    points: [
  ...
  },
  {
    id: "security",
    title: "CRM Security",
    desc: "Protect your business data with enterprise-grade security, access control, and regular backups.",
    points: [
  ...
  },
  {
    ...
    desc: "We provide continuous CRM maintenance, updates, and technical support to keep your system running smoothly.",
    points: [
...
export default CRMExpertiseDetails;
