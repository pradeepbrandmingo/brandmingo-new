...
const steps = [
  {
    ...
    desc: "We analyze your business processes, workflows, and CRM requirements to create the right solution.",
  },
  {
    num: "02",
    icon: "fa-solid fa-sitemap",
    title: "CRM Planning",
    desc: "We design the CRM architecture, user roles, modules, and workflows based on your business needs.",
  },
  {
    num: "03",
    icon: "fa-solid fa-laptop-code",
    title: "CRM Development",
    desc: "Our developers build a secure, scalable, and feature-rich CRM with custom functionality and integrations.",
  },
  {
    num: "04",
    icon: "fa-solid fa-shield-halved",
    title: "Testing & Quality Assurance",
    desc: "We thoroughly test every CRM feature to ensure security, performance, and a seamless user experience.",
  },
  {
    num: "05",
    icon: "fa-solid fa-rocket",
    title: "Deployment & Support",
    desc: "We deploy your CRM smoothly, provide user training, and offer ongoing maintenance and support.",
  },
];
...
export default function CRMProcessSection() {
