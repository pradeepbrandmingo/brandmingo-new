...
const servicesData = [
  {
    ...
    desc: "Generate qualified leads with Google Ads campaigns designed to attract high-intent customers and drive business growth.",
    points: [
      "Reach high-intent search audiences",
      "Increase lead quality & conversions",
      "Lower cost per qualified lead",
      "Scale lead generation consistently",
    ],
  },
  {
    id: "ecom",
    title: "E-commerce Advertising",
    desc: "Boost online sales with Google Shopping, Search, and Performance Max campaigns optimized for higher ROAS.",
    points: [
      "Increase product visibility",
      "Maximize ROAS with smart bidding",
      "Optimize Shopping campaigns",
      "Drive consistent online sales",
    ],
  },
  {
    id: "gads",
    title: "Google Ads Management",
    desc: "Complete Google Ads management focused on improving campaign performance, lowering CPC, and maximizing ROI.",
    points: [
  ...
  },
  {
    ...
    desc: "Combine Google Ads with Meta campaigns to build a powerful multi-channel advertising strategy.",
    points: [
  ...
  },
  {
    ...
    desc: "Reconnect with previous visitors and convert missed opportunities into qualified customers.",
    points: [
  ...
  },
  {
    ...
    desc: "Optimize landing pages to improve user experience and maximize conversions from every Google Ads click.",
    points: [
  ...
  },
  {
    ...
    desc: "Measure every click, lead, and sale with accurate conversion tracking and performance analytics.",
    points: [
  ...
  },
  {
    ...
    desc: "Scale winning Google Ads campaigns with continuous optimization and data-driven growth strategies.",
    points: [
      "Scale successful campaigns",
      "Optimize budget allocation",
      "Improve ROAS continuously",
      "Drive long-term growth",
    ],
  },
];

const GoogleAdsExpertiseDetails = () => {
...
export default GoogleAdsExpertiseDetails;
