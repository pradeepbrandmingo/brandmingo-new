        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Brand Identity" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Corporate Branding</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/4ff753c4-c41f-4713-93db-849064cf418e/esLYqBQWdy.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Visual Identity
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Market Positioning
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Build a powerful and consistent brand identity that reflects your
              vision and connects with your audience. We create strategic,
              memorable branding that builds trust, recognition, and long-term
              business growth.
            </p>
...
export default CorporateBrandingHero;
