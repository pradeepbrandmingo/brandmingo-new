        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Planning" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Strategy Planning</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/bd8234fb-60cb-4647-88e4-90084e23666d/8ldfSQ68bd.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-1">
              <i className="fas fa-chart-line" /> Data-Driven Strategy
            </div>
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Content Planning
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Consistent Growth
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Build a clear and results-driven social media strategy that aligns
              with your business goals. We don’t just post content — we plan,
              analyze, and create structured strategies that improve brand
...
export default StrategyPlanningHero;
