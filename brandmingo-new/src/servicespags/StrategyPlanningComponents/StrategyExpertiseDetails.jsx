...
const servicesData = [
  {
    ...
    desc: "We develop data-driven business strategies that align with your goals and create a roadmap for sustainable growth.",
    points: [
      "Define clear business objectives",
      "Build scalable growth strategies",
      "Identify market opportunities",
      "Create actionable business roadmaps",
    ],
  },
  {
    id: "market",
    title: "Market Research",
    desc: "Understand industry trends, competitors, and customer demand to make informed business decisions.",
    points: [
  ...
  },
  {
    ...
    desc: "Discover customer behavior, preferences, and demographics to create targeted growth strategies.",
    points: [
  ...
  },
  {
    ...
    desc: "Create structured action plans that guide your business toward long-term growth and success.",
    points: [
  ...
  },
  {
    ...
    desc: "Evaluate competitors to uncover strengths, weaknesses, and opportunities for market positioning.",
    points: [
  ...
  },
  {
    ...
    desc: "Develop practical strategies that improve efficiency, reduce risks, and support business growth.",
    points: [
  ...
  },
  {
    ...
    desc: "Monitor business performance with data-driven insights to improve strategies and achieve better results.",
    points: [
  ...
  },
  {
    ...
    desc: "Get expert guidance to refine your strategy, overcome challenges, and accelerate business growth.",
    points: [
...
const StrategyExpertiseDetails = () => {
      ...
      <div className="react-expertise-section">
        <div className="auto-container">
          <h3 className="mb-5 text-center section-main-h3">
            Our Business Strategy Expertise
          </h3>
...
export default StrategyExpertiseDetails;
