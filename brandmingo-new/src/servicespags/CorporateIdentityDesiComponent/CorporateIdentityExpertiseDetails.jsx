...
const servicesData = [
  {
    ...
    desc: "Build a strong corporate identity that reflects your company's vision, values, and long-term business goals.",
    points: [
  ...
  },
  {
    ...
    desc: "Design professional logos, color palettes, typography, and visual elements that represent your brand consistently.",
    points: [
      "Custom logo design",
  ...
  },
  {
    ...
    desc: "Create premium business stationery that reinforces your corporate identity across every professional interaction.",
    points: [
      "Business cards",
  ...
  },
  {
    ...
    desc: "Develop comprehensive brand guidelines to maintain consistency across digital and print media.",
    points: [
  ...
  },
  {
    ...
    desc: "Design digital branding materials that keep your business looking professional across all online platforms.",
    points: [
  ...
  },
  {
    ...
    desc: "Create impactful marketing materials that strengthen your brand identity and communicate your message effectively.",
    points: [
      "Brochures & flyers",
      "Company profiles",
  ...
  {
    id: "packaging",
    title: "Corporate Identity Applications",
    desc: "Apply your corporate identity consistently across products, packaging, office branding, and promotional materials.",
    points: [
      "Office branding",
  ...
  },
  {
    ...
    desc: "Ensure your corporate identity remains consistent as your business grows with continuous design support.",
    points: [
      "Identity updates & revisions",
      "Brand consistency audits",
      "Ongoing design support",
      "Scalable branding solutions",
    ],
  },
];

const CorporateIdentityExpertiseDetails = () => {
      ...
      <div className="react-expertise-section">
        <div className="auto-container">
          <h3 className="mb-5 text-center section-main-h3">
            Our Corporate Identity Designing Expertise
          </h3>
...
export default CorporateIdentityExpertiseDetails;
