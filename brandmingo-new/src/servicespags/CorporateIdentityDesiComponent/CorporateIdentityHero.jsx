        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Designing" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Corporate Identity Designing</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/1dee9d48-e67d-4b80-b193-bf92c71a43c5/tsqHIaA8Mz.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Professional Identity
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Strong Recognition
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Build a strong and professional brand identity that reflects your
              business vision and values. We don’t just create designs — we
              craft consistent visual identities that improve brand recognition,
...
export default CorporateIdentityHero;
