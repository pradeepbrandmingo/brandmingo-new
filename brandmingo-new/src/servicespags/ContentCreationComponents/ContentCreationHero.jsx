        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Creation" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Content Creation & Publishing</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/02e76512-d9d4-48dc-b288-c18e9cf49b8c/PknBLS1WIa.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Consistent Posting
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> High Engagement
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Create engaging, high-quality content that connects with your
              audience and builds your brand presence. We don’t just design
              posts — we craft strategic content and publish it consistently to
              boost engagement, visibility, and growth.
            </p>
