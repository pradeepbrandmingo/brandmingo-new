...
const servicesData = [
  {
    ...
    desc: "We create result-driven content strategies aligned with your brand, audience, and business goals.",
    points: [
  ...
  },
  {
    ...
    desc: "High-converting website copy that clearly communicates your value and increases engagement.",
    points: [
      "Landing page copy",
  ...
  },
  {
    ...
    desc: "SEO-friendly content designed to improve search rankings and drive organic traffic.",
    points: [
  ...
  },
  {
    ...
    desc: "Engaging blogs and articles that educate your audience and establish brand authority.",
    points: [
  ...
  },
  {
    ...
    desc: "Creative content that increases engagement and strengthens your brand across social platforms.",
    points: [
      "Post captions & creatives",
      "Campaign content",
  ...
  },
  {
    ...
    desc: "Persuasive product descriptions that highlight benefits and encourage more purchases.",
    points: [
  ...
  },
  {
    ...
    desc: "Professional email content for promotions, newsletters, and customer engagement campaigns.",
    points: [
      "Promotional emails",
      "Newsletter content",
  ...
  },
  {
    ...
    desc: "Improve existing content for better readability, SEO performance, and higher conversions.",
    points: [
      "Content auditing",
      "SEO improvements",
...
const ContentCreationExpertiseDetails = () => {
...
export default ContentCreationExpertiseDetails;
