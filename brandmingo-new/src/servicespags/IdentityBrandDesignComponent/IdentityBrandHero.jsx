        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Identity Design" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Brand Identity Design</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/274a8252-f23f-49bf-9ed0-41fe58c5e6fa/g7KqrUhypa.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> trong Brand Recall
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Create a powerful and recognizable brand identity that reflects
              your business personality and values. We don’t just design visuals
              — we build complete brand systems that improve consistency, trust,
...
export default IdentityBrandHero;
