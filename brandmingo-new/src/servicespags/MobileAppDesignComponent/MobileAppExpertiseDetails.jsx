...
const servicesData = [
  {
    id: "uiux",
    title: "UI/UX Design",
    desc: "We create visually stunning and user-centric mobile app interfaces that deliver seamless experiences across Android and iOS devices.",
    points: [
      "Modern and intuitive UI design",
      "User-centered experience planning",
      "Pixel-perfect interface layouts",
  ...
  },
  {
    ...
    desc: "Plan every screen with detailed wireframes and user journeys to ensure smooth navigation and better usability.",
    points: [
  ...
  },
  {
    ...
    desc: "Validate your app idea with clickable prototypes that simulate real user interactions before development begins.",
    points: [
      "High-fidelity prototypes",
      "Realistic app interactions",
  ...
  },
  {
    ...
    desc: "Design responsive mobile applications that provide a consistent experience across smartphones, tablets, and multiple screen sizes.",
    points: [
  ...
  },
  {
    ...
    desc: "Build scalable design systems with reusable UI components to maintain consistency throughout your application.",
    points: [
  ...
  },
  {
    ...
    desc: "Identify usability issues through user testing and optimize the app experience before launch.",
    points: [
  ...
  },
  {
    ...
    desc: "Enhance user engagement with meaningful animations and smooth transitions that create delightful app experiences.",
    points: [
  ...
  },
  {
    ...
    desc: "We continuously refine your app design with feedback, updates, and usability improvements for long-term success.",
    points: [
...
const MobileAppExpertiseDetails = () => {
      ...
      <div className="react-expertise-section">
        <div className="auto-container">
          <h3 className="mb-5 text-center section-main-h3">
            Our Mobile App Design Expertise
          </h3>
...
export default MobileAppExpertiseDetails;
