        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="App Design" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Mobile App Design</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/53ceddc3-877b-4380-82ab-2a1506a04abe/eLRZvV6bhG.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> App Prototyping
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> High Performance
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Design intuitive and visually engaging mobile apps that deliver
              seamless user experiences. We craft user-centric, high-performance
              app interfaces that drive engagement, retention, and business
              growth
            </p>
