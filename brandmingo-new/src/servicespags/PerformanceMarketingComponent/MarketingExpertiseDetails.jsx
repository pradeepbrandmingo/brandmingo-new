...
const servicesData = [
  {
    ...
    desc: "Generate qualified leads through data-driven campaigns designed to increase conversions and business growth.",
    points: [
      "Target high-intent audiences for quality leads",
      "Optimize landing pages for better conversions",
      "Reduce cost per lead with smart optimization",
      "Build consistent and scalable lead generation",
    ],
  },
  {
    id: "legacy",
    title: "E-commerce Advertising",
    desc: "Drive online sales with high-performing ecommerce advertising campaigns built to maximize revenue and ROI.",
    points: [
      "Promote products to high-intent shoppers",
      "Optimize shopping campaigns for more sales",
      "Recover abandoned carts with remarketing",
      "Scale profitable ecommerce advertising",
    ],
  },
  {
    id: "pwa",
    title: "Google Ads Management",
    desc: "Reach customers actively searching for your services through optimized Google Ads campaigns.",
    points: [
      "Target valuable search keywords effectively",
      "Create high-converting search advertisements",
      "Optimize bidding for maximum campaign ROI",
      "Improve conversions with ongoing optimization",
    ],
  },
  {
    id: "api",
    title: "Meta Ads (Facebook & Instagram)",
    desc: "Reach the right audience with engaging Meta advertising focused on leads, sales, and business growth.",
    points: [
      "Build precise audience targeting campaigns",
      "Create engaging creatives that convert",
      "Generate quality leads through Meta Ads",
      "Scale campaigns with performance insights",
    ],
  },
  {
    id: "ecommerce",
    title: "Retargeting & Remarketing",
    desc: "Reconnect with interested visitors and convert them into loyal customers through remarketing campaigns.",
    points: [
      "Reconnect with previous website visitors",
      "Recover abandoned leads and customers",
      "Increase repeat purchases through remarketing",
  ...
  },
  {
    ...
    desc: "Improve every stage of your sales funnel to increase conversions and maximize marketing performance.",
    points: [
      "Optimize landing pages for better results",
      "Reduce drop-offs across every funnel stage",
      "Increase lead-to-customer conversion rates",
      "Maximize revenue through funnel optimization",
    ],
  },
  {
    id: "migration",
    title: "Analytics & Tracking Setup",
    desc: "Implement advanced tracking systems to measure campaign performance and improve marketing decisions.",
    points: [
      "Configure accurate conversion tracking setup",
      "Monitor leads, sales, and user behavior",
      "Measure campaign performance with insights",
      "Support smarter marketing decisions daily",
    ],
  },
  {
    id: "payment",
    title: "Campaign Scaling & Optimization",
    desc: "Continuously optimize and scale campaigns to maximize ROI and achieve sustainable business growth.",
    points: [
      "Scale winning campaigns with confidence",
      "Optimize budgets for maximum efficiency",
      "Improve performance through continuous testing",
      "Increase ROI with data-driven optimization",
    ],
  },
];

const MarketingExpertiseDetails = () => {
...
export default MarketingExpertiseDetails;
