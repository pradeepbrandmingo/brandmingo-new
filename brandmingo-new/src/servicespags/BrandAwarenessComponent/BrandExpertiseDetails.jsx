...
const servicesData = [
  {
    ...
    desc: "Build a strong brand presence across social media platforms with engaging content and consistent messaging.",
    points: [
  ...
  },
  {
    ...
    desc: "Increase brand visibility with eye-catching display ads across premium websites and apps.",
    points: [
  ...
  },
  {
    ...
    desc: "Promote your brand through engaging video campaigns on YouTube, Instagram, Facebook, and other platforms.",
    points: [
  ...
  },
  {
    ...
    desc: "Partner with trusted influencers to expand your reach and build credibility with your target audience.",
    points: [
  ...
  },
  {
    ...
    desc: "Create valuable content that increases brand awareness, trust, and audience engagement.",
    points: [
  ...
  },
  {
    ...
    desc: "Strengthen your brand image by managing reviews, mentions, and customer feedback effectively.",
    points: [
      "Review management",
      "Brand monitoring",
  ...
  },
  {
    ...
    desc: "Reach the right audience with advanced demographic, interest, and behavioral targeting strategies.",
    points: [
  ...
  },
  {
    ...
    desc: "Track campaign performance with detailed reports and actionable insights to improve brand awareness.",
    points: [
      "Performance tracking",
      "Reach & impression reports",
      "Engagement analysis",
...
export default BrandExpertiseDetails;
