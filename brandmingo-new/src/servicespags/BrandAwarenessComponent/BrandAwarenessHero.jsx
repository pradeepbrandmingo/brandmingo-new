      ...
      <div className="auto-container">
        <div className="rdh-grid">
          ...
          >
            ...
            <h1 className="title">Brand Awareness</h1>
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Brand Awareness</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/0814ebf6-11ea-4f17-baad-37246419a7d7/XblPn2hwl7.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Consistent Visibility
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Audience Engagement
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Build a strong brand presence with strategic social media
              campaigns designed to increase visibility and recognition. We
              create content-driven strategies that help your brand reach the
              right audience, stay memorable, and grow consistently.
            </p>
...
export default BrandAwarenessHero;
