...
const servicesData = [
  {
    ...
    title: "Engagement Strategy & Planning",
    desc: "We create customized engagement strategies that help businesses build stronger customer relationships and long-term brand loyalty.",
    points: [
  ...
  },
  {
    ...
    desc: "Increase customer participation through personalized campaigns, loyalty initiatives, and meaningful interactions.",
    points: [
  ...
  },
  {
    ...
    desc: "Build active online communities that strengthen your brand and encourage long-term customer relationships.",
    points: [
  ...
  },
  {
    ...
    desc: "Increase engagement across social media platforms with compelling content and interactive campaigns.",
    points: [
  ...
  },
  {
    ...
    desc: "Enhance every customer touchpoint to deliver seamless experiences that improve engagement and retention.",
    points: [
  ...
  },
  {
    ...
    desc: "Keep customers engaged with personalized communication and long-term relationship-building strategies.",
    points: [
  ...
  },
  {
    ...
    desc: "Measure engagement performance with actionable insights to continuously improve customer experiences.",
    points: [
  ...
  {
    id: "loyalty",
    title: "Loyalty & Advocacy Programs",
    desc: "Turn satisfied customers into loyal brand advocates through rewards, referrals, and engagement initiatives.",
    points: [
      ...
      <div className="react-expertise-section">
        <div className="auto-container">
          <h3 className="mb-5 text-center section-main-h3">
            Our Engagement Growth Expertise
          </h3>
...
export default GrowthExpertiseDetails;
