        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Growth" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Engagement & Growth</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/f87ca4e1-e121-413f-acbc-e40e6ebe30a5/f3DEdgED0u.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Audience Growth
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Higher Conversions
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Boost your brand engagement and turn your audience into loyal
              customers. We don’t just post content — we actively manage
              interactions, optimize performance, and implement growth
              strategies to increase reach, engagement, and conversions.
            </p>
...
export default EngagementGrowthHero;
