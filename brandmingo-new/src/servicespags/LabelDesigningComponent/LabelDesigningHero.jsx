        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text=" Label Designing" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Package & Label Designing</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/8dc93809-1fc7-4a75-8803-f2b438f49517/OgkyjnNDFk.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Product Branding
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Shelf Impact
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Create attractive packaging and label designs that make your
              products stand out on every shelf. We don’t just design packaging
              — we craft visually impactful branding that builds trust, improves
              product appeal, and drives customer attention.
            </p>
...
export default LabelDesigningHero;
