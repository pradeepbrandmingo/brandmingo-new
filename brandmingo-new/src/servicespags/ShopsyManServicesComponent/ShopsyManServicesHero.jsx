        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Shopsy Management</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/0f461920-1bc2-4206-9123-9c04202d6dfd/110ZnX8nnN.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Grow your Shopsy store with expert management that improves
              product visibility, boosts sales, and drives consistent
              marketplace growth.
            </p>
...
export default ShopsyManServicesHero;
