        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Product Design</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/013da495-2bf4-4189-8828-939859037409/atiJl9bgPu.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Product Strategy
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Scalable Design Systems
            </div>
          ...
          <div className="rdh-bottom-block">
            <p className="rdh-desc">
              Design impactful digital products that solve real problems and
              deliver seamless user experiences. We combine strategy, usability,
              and aesthetics to create products that users love and businesses
              grow with.
            </p>
