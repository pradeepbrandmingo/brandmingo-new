...
const servicesData = [
  {
    ...
    desc: "We define a clear product vision through market research, user insights, and business goals to create products that solve real problems.",
    points: [
  ...
  },
  {
    ...
    desc: "Understand your users through research and design intuitive experiences that improve engagement and satisfaction.",
    points: [
  ...
  },
  {
    ...
    desc: "Transform ideas into interactive wireframes and prototypes before development begins.",
    points: [
  ...
  },
  {
    id: "ui",
    title: "UI Design",
    desc: "Design visually appealing and modern interfaces that deliver exceptional user experiences across all devices.",
    points: [
      "Modern UI design",
      "Responsive layouts",
  ...
  },
  {
    ...
    desc: "Build scalable design systems and reusable UI components for faster and more consistent product development.",
    points: [
  ...
  },
  {
    ...
    desc: "Validate designs with real users to identify improvements and create products that people love to use.",
    points: [
  ...
  },
  {
    ...
    desc: "Deliver organized design files, specifications, and assets for a smooth and efficient development process.",
    points: [
  ...
  },
  {
    ...
    desc: "Continuously improve your product with design updates based on analytics, testing, and user behavior.",
    points: [
...
const ProductDesignExpertiseDetails = () => {
...
export default ProductDesignExpertiseDetails;
