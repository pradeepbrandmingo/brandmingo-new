...
const steps = [
  {
    ...
    desc: "Identify decision-makers and ideal business audiences.",
  },
  {
    num: "02",
    icon: "fas fa-bullseye",
    title: "Campaign Strategy",
    desc: "Build a tailored LinkedIn Ads strategy for your goals.",
  },
  {
    num: "03",
    icon: "fas fa-rectangle-ad",
    title: "Campaign Launch",
    desc: "Launch optimized ads with precise professional targeting.",
  },
  {
    num: "04",
    icon: "fas fa-chart-line",
    title: "Optimization",
    desc: "Improve campaign performance using real-time insights.",
  },
  {
    num: "05",
    icon: "fas fa-arrow-trend-up",
    title: "Scale & Growth",
    desc: "Scale winning campaigns to maximize ROI and leads.",
  },
];
...
export default function LinkedinProcessSection() {
      ...
      <div className="ps-inner">
        ...
        <div className="ps-left">
          ...
          <h2 className="ps-heading">
            ...
            <br />
            LinkedIn
            <span className="ora"> Ads process</span>
          </h2>
          <p className="ps-sub">
            We use a strategic and data-driven approach to build LinkedIn Ads
            campaigns that generate qualified B2B leads, increase brand
            visibility, and maximize business growth.
          </p>
          <a
            href="/"
            className="ps-btn"
