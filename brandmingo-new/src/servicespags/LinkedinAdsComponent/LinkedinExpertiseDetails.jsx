...
const servicesData = [
  {
    ...
    desc: "Generate qualified B2B leads with LinkedIn Ads campaigns designed to connect your business with decision-makers and high-value prospects.",
    points: [
      "Reach decision-makers and business leaders",
      "Generate high-quality B2B leads",
      "Reduce cost per qualified lead",
      "Scale predictable lead generation",
    ],
  },
  {
    id: "brand",
    title: "Brand Awareness Campaigns",
    desc: "Increase your brand visibility among professionals and industry leaders with LinkedIn campaigns built for long-term business growth.",
    points: [
      "Increase professional brand awareness",
      "Reach targeted business audiences",
  ...
  },
  {
    ...
    desc: "We manage every aspect of your LinkedIn Ads campaigns to improve performance, generate better leads, and maximize advertising ROI.",
    points: [
  ...
  },
  {
    ...
    desc: "Promote valuable content to the right professionals and increase engagement through high-performing Sponsored Content campaigns.",
    points: [
      "Promote blogs and case studies",
  ...
  },
  {
    ...
    desc: "Reconnect with previous website visitors and engaged users using LinkedIn remarketing campaigns that improve conversion rates.",
    points: [
  ...
  },
  {
    ...
    desc: "Optimize every stage of your B2B sales funnel to improve lead quality, increase conversions, and reduce acquisition costs.",
    points: [
  ...
  {
    id: "tracking",
    title: "Insight Tag & Analytics",
    desc: "Track campaign performance with LinkedIn Insight Tag and advanced analytics to make smarter marketing decisions.",
    points: [
  ...
  },
  {
    ...
    desc: "Scale winning LinkedIn Ads campaigns using continuous optimization, audience refinement, and performance-based strategies.",
    points: [
...
const LinkedinExpertiseDetails = () => {
...
export default LinkedinExpertiseDetails;
