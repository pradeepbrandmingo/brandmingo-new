        ...
        <div className="rdh-grid">
          ...
          >
            ...
            <div className="rdh-liquid-wrap">
              <GradientText text="Traffic Growth" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Organic Traffic</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/a5c5b2e2-7307-4a62-ad47-236888ba8f70/7nbhPoTvPV.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
...
export default OrganicTrafficHero;
