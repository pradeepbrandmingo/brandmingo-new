      ...
      <div className="auto-container">
        ...
        <div className="wcb-grid">
          ...
          <div className="wcb-card">
            ...
            <p className="wcb-feat-desc">
              Rapid iterations, clear milestones, and transparent workflows that
          ...
          <div className="wcb-card">
            ...
            <p className="wcb-feat-desc">
              Round-the-clock support with rapid issue resolution whenever your
              brand needs us most.
            </p>
          </div>
...
export default WhyChooseBMShopify;
