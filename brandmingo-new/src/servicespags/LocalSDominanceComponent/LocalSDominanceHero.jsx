      ...
      <div className="auto-container">
        <div className="rdh-grid">
          ...
          >
            ...
            <h1 className="title">Local Search </h1>
            <div className="rdh-liquid-wrap">
              <GradientText text="Dominance" fontFamily={ff} />
            </div>
            <ul className="rdh-breadcrumb">
              ...
              <li className="sep">/</li>
              <li className="active">Local SEO</li>
            </ul>
          </div>
          ...
          <div className="rdh-right">
            ...
            <div className="rdh-atom-wrap rdh-no-spin">
              <DotLottieReact
                src="https://lottie.host/ba7b6cdc-8d7b-459f-b00b-7f512907a61c/GQKurTMLz1.lottie"
                autoplay
                loop
                style={{
                  width: "110%",
            ...
            <div className="rdh-chip rdh-chip-1">
              <i className="fas fa-chart-line" /> Google Map Ranking
            </div>
            <div className="rdh-chip rdh-chip-2">
              <i className="fas fa-bullseye" /> Local Visibility
            </div>
            <div className="rdh-chip rdh-chip-3">
              <i className="fas fa-rocket" /> Nearby Leads
            </div>
...
export default LocalSDominanceHero;
